...
public class MyFunctionEvaluator extends AbstractMappedFunctionEvaluator implements FunctionEvaluator
{
	public MyFunctionEvaluator(EvaluatorFactory evaluatorFactory)
	{
