...
public final class ComparisonExpressionParser extends AbstractParser<Expression>
{
	...
	Expression parseNotExpression(MatchingSqlTokenizer tokenizer)
		throws ParserException,
		IOException
	{
	...
	Expression parseComparisonExpression(MatchingSqlTokenizer tokenizer)
		throws ParserException,
		IOException
	{
	...
	// Expression parseTypeExpression(MatchingSqlTokenizer tokenizer)
	...
	Expression parseNullConstant(MatchingSqlTokenizer tokenizer)
		throws ParserException,
		IOException
	{
		Expression expression=null;
	...
	AndExpression parseAndExpression(MatchingSqlTokenizer tokenizer)
		throws ParserException,
		IOException
	{
